proc ps7_pll_init_data_3_0 {} {
    ...
    mask_write 0XF8000114 0x003FFFF0 0x000FA3C0
    mask_write 0XF8000104 0x0007F000 0x0002D000
...
proc ps7_clock_init_data_3_0 {} {
    mwr -force 0XF8000008 0x0000DF0D
    mask_write 0XF8000128 0x03F03F01 0x00402501
...
proc ps7_ddr_init_data_3_0 {} {
    ...
    mask_write 0XF8006004 0x0007FFFF 0x0000103C
    ...
    mask_write 0XF8006014 0x001FFFFF 0x000412CD
    mask_write 0XF8006018 0xF7FFFFFF 0x425128CE
    ...
    mask_write 0XF8006034 0x13FF3FFF 0x00010AB4
    ...
    mask_write 0XF80060A8 0x0FFFFFFF 0x03105F5E
    mask_write 0XF80060AC 0x000001FF 0x000000F6
    ...
    mask_write 0XF800612C 0x000FFFFF 0x00020000
    mask_write 0XF8006130 0x000FFFFF 0x00020000
    mask_write 0XF8006134 0x000FFFFF 0x00020000
    mask_write 0XF8006138 0x000FFFFF 0x00020000
    ...
    mask_write 0XF8006170 0x001FFFFF 0x000000D5
    mask_write 0XF8006174 0x001FFFFF 0x000000D5
    ...
    mask_write 0XF80062B0 0x003FFFFF 0x00005095
    mask_write 0XF80062B4 0x0003FFFF 0x00000950
...
proc ps7_ddr_init_data_2_0 {} {
    mask_write 0XF8006000 0x0001FFFF 0x00000080
    mask_write 0XF8006004 0x1FFFFFFF 0x0008103C
    mask_write 0XF8006008 0x03FFFFFF 0x03C0780F
    mask_write 0XF800600C 0x03FFFFFF 0x02001001
    mask_write 0XF8006010 0x03FFFFFF 0x00014001
    mask_write 0XF8006014 0x001FFFFF 0x000412CD
